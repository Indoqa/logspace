 ...
 * <br>
 * Internally, this factory uses an {@link io.logspace.agent.api.AgentControllerDescriptionDeserializer
 * AgentControllerDescriptionDeserializer} to read AgentControllerDescriptions from an {@link InputStream}. The actual implementation
 * to be used can be configured with the system-property 'logspace.configuration-deserializer'.<br>
 * If no implementation is configured, this factory will fall back to using the
 * <b>io.logspace.agent.api.json.AgentControllerDescriptionJsonDeserializer</b>
 */
